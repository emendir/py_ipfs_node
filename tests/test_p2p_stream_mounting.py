...
def run():
    ...
    assert server_node.tcp.open_listener(protocol, f"/ip4/127.0.0.1/tcp/{echo_port}")
    ...
    client_port = 8888
    assert client_node.tcp.open_sender(protocol, f"/ip4/127.0.0.1/tcp/{client_port}", server_node.peer_id)
