...
def main():
    ...
    try:
        ...
        if args.listen:
            ...
            result = node.open_listener(args.protocol, f"/ip4/127.0.0.1/tcp/{args.port}")
            if result:
            ...
            result = node.open_sender(args.protocol, f"/ip4/127.0.0.1/tcp/{args.port}", f"{args.peer_id}")
            if result:
